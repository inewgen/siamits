...
<div class="content-wrapper">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a href="<?php echo URL::to('pages/add');?>">
                            <button class="btn btn-success" id="new_pages">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form id="frm_main" role="form" method="get" action="<?php echo URL::to('pages');?>" enctype="multipart/form-data">
                            
                            <div class="row">
                                <div class="col-xs-6">
                                    <div id="tb_pages_length" class="dataTables_length">
                                        <label>
                                            <select id="perpage" name="perpage" size="1" aria-controls="tb_pages">
    ...
    <?php endif;?>
                        ...
                        <form id="frm_main2" role="form" method="post" action="<?php echo URL::to('pages');?>" enctype="multipart/form-data">
