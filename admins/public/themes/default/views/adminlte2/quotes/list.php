...
<div class="content-wrapper">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <!-- <h3 class="box-title">List Quotes</h3> -->
                        <a href="<?php echo URL::to('quotes/add');?>">
                            <button class="btn btn-success" id="new_quotes">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form id="frm_main" role="form" method="get" action="<?php echo URL::to('quotes');?>" enctype="multipart/form-data">
                            
                            <div class="row">
                                <div class="col-xs-6">
                                    <div id="tb_quotes_length" class="dataTables_length">
                                        <label>
                                            <select id="perpage" name="perpage" size="1" aria-controls="tb_quotes">
    ...
    <?php foreach ($data as $key => $value): ?>
                    ...
                    <?php           else: ?>
                                        <td>
                                            <img src="<?php echo getImageLink('img', 'quotes', 'siamts', 'png', 200, 143, 'banner.jpg');?>" width="200px">
                                        </td>
                    <?php           endif;?>
                    <?php       elseif ($key2 == 'manage'): ?>
                                        <td>
                                            <a title="Edit" href="<?php echo URL::to('quotes');?>/<?php echo array_get($value, 'id', '');?>"><span class="glyphicon glyphicon-pencil"></span></a>
    ...
    <?php endif;?>
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <div class="dataTables_info" id="tb_quotes_info">Showing <?php echo $pagination->getFrom();?>
                        ...
                        <form id="frm_main2" role="form" method="post" action="<?php echo URL::to('quotes');?>" enctype="multipart/form-data">
