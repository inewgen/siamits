<header class="main-header">
    <!-- Logo -->
    <a href="<?php echo URL::to('public/themes/adminlte2');?>/index2.html" class="logo">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b><font color="#01ac34">S</font>i<font color="#01ac34">T</font></b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><img alt="" src="<?php echo URL::to('public/themes/default');?>/assets/img/simits_logo_114x23.png"></span>
    </a>
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li>
                                    ...
                                    <a href="<?php echo URL::to('public/themes/adminlte2');?>/#">
                                        <div class="pull-left">
                                            <img src="<?php echo URL::to('public/themes/adminlte2');?>/assets/img/user3-128x128.jpg" class="img-circle" alt="user image" />
                                        </div>
                                        <h4>
                            Support Team
                            ...
                            <small><i class="fa fa-clock-o"></i> 2 hours</small>
                                ...
                                <li>
                                    <a href="<?php echo URL::to('public/themes/adminlte2');?>/#">
                                        <div class="pull-left">
                                            <img src="<?php echo URL::to('public/themes/adminlte2');?>/assets/img/user4-128x128.jpg" class="img-circle" alt="user image" />
                                        </div>
                                        <h4>
                            Developers
                ...
                <li class="dropdown user user-menu">
                    <a href="<?php echo URL::to('public/themes/adminlte2');?>/#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <?php if(isset($user->images[0]->url)): ?>
                                    <img src="<?php echo isset($user->images[0]->url)?$user->images[0]->url:'';?>" class="user-image" alt="User Image" />
                                <?php else: ?>
                                ...
                                <?php       $img_rand = 'm01'; ?>
                                <?php   endif; ?>
                                    <img src="<?php echo URL::to('public/themes/adminlte2');?>/assets/img/avatar/<?php echo $img_rand;?>.png" class="user-image" alt="User Image" />
                                <?php endif; ?>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if(isset($user->images[0]->url)): ?>
                            <img src="<?php echo isset($user->images[0]->url)?$user->images[0]->url:'';?>" class="img-circle" alt="User Image" />
                        <?php else: ?>
                        <?php   if(isset($user->gender) && ($user->gender == 'female')): ?>
                        <?php       $img_rand = 'f01'; ?>
                        <?php   else: ?>
                        <?php       $img_rand = 'm01'; ?>
                        <?php   endif; ?>
                            <img src="<?php echo URL::to('public/themes/adminlte2');?>/assets/img/avatar/<?php echo $img_rand;?>.png" class="img-circle" alt="User Image" />
                        <?php endif; ?>
...
?>
                        ...
                        <li class="user-body">
                            <div class="col-xs-12 text-center">
                                <a href="<?php echo URL::to('admins/profile/password');?>">Change password</a>
                            </div>
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?php echo URL::to('admins/profile');?>" class="btn btn-default btn-flat">Profile</a>
                            </div>
