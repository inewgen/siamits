...
<div class="content-wrapper">
    ...
    <?php foreach ($banners['data']['record'] as $key => $value): ?>
                                    <tr>
                                        ...
                                        <td><img src="<?php echo $value['image_url'];?>" width="200px"></td>
                                        <td><?php echo $value['status'];?></td>
                                        <td>
                                            <a title="Edit" href="<?php echo URL::to('banners');?>/<?php echo $value['id'];?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                            <a class="del_banner" data="<?php echo $value['id'];?>" title="Delete" href="javascript:void(0)" onclick="del_banner('<?php echo $value['id'];?>', '<?php echo $value['image_name'];?>')"><span class="glyphicon glyphicon-remove-sign danger"></span></a>
