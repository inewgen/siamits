...
Theme::asset()->add('datepicker3', 'public/themes/adminlte2/assets/plugins/bootstrap-datepicker-thai-thai/css/datepicker.css');
Theme::asset()->add('uploadify-css', 'public/themes/adminlte2/assets/plugins/uploadify/uploadify.css');
Theme::asset()->add('ace-css', 'public/themes/adminlte2/assets/plugins/css/ace.thumbnails.css');
...
Theme::asset()->container('footer')->add('datepicker-bootrap-th-1', 'public/themes/adminlte2/assets/plugins/bootstrap-datepicker-thai-thai/js/bootstrap-datepicker.js');
Theme::asset()->container('footer')->add('datepicker-bootrap-th-2', 'public/themes/adminlte2/assets/plugins/bootstrap-datepicker-thai-thai/js/bootstrap-datepicker-thai.js');
Theme::asset()->container('footer')->add('datepicker-bootrap-th-3', 'public/themes/adminlte2/assets/plugins/bootstrap-datepicker-thai-thai/js/locales/bootstrap-datepicker.th.js');
Theme::asset()->container('footer')->add('uploadify', 'public/themes/adminlte2/assets/plugins/uploadify/jquery.uploadify.min.js');
Theme::asset()->container('footer')->add('zclip', 'public/themes/adminlte2/assets/plugins/zclip/jquery.zclip.js');
?>
...
<script type="text/javascript">
	...
	$(function () {
        ...
        $('#file_upload').uploadify({
            ...
            //'debug'    : true,
            'multi'    : false,
            'swf'      : '<?php echo URL::to("public/themes/adminlte2");?>/assets/plugins/uploadify/uploadify.swf',
            ...
            'onUploadSuccess' : function(file, data, response) {
                ...
                if(status_code != '0'){
                    ...
                    $('.copy-link-wrap').zclip({
                        path: '<?php echo URL::to("public");?>/themes/adminlte2/assets/plugins/zclip/ZeroClipboard.swf',
...
<?php           if(isset($user->gender) && ($user->gender == 'female')):
                ...
                $url_avatar = URL::to('public/themes/adminlte2').'/assets/img/avatar/'.trim($img_rand).'.png';
?>
