...
<div class="page-banner">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h2>News</h2>
                <p>เผยโฉมแอพ Instagram บนนาฬิกา Apple Watch</p>
            </div>
            <div class="col-md-6">
                <ul class="breadcrumbs">
                    <li><a href="<?php echo URL::to('');?>">Home</a></li>
                    <li><a href="<?php echo URL::to('news');?>">News</a></li>
                    <li>เผยโฉมแอพ Instagram บนนาฬิกา Apple Watch</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="blog-post gallery-post">
                    ...
                    <div class="post-head">
                        <div class="touch-slider post-slider">
                            <div class="item">
                                <a class="lightbox" title="This is an image title" href="<?php echo URL::to('public/themes/margo');?>/assets/img/slider/bgs1.png" data-lightbox-gallery="gallery1">
                                    <div class="thumb-overlay"><i class="fa fa-arrows-alt"></i></div>
                                    <img alt="" src="<?php echo URL::to('public/themes/margo');?>/assets/img/slider/bgs1.png">
                                </a>
                            </div>
                            <div class="item">
                                <a class="lightbox" title="This is an image title" href="<?php echo URL::to('public/themes/margo');?>/assets/img/slider/bgs2.png" data-lightbox-gallery="gallery2">
                                    <div class="thumb-overlay"><i class="fa fa-arrows-alt"></i></div>
                                    <img alt="" src="<?php echo URL::to('public/themes/margo');?>/assets/img/slider/bgs2.png">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="post-content">
                        ...
                        <h2>เผยโฉมแอพ Instagram บนนาฬิกา Apple Watch</h2>
                        <ul class="post-meta">
