...
<?php $id = array_get($pages, 'id', '');?>
var $ = jQuery.noConflict();
var likes_pages_<?php echo $id;?> = '';
...
$(window).load(function () {
	...
	$.ajax({
		type: "GET",
		url: "<?php echo URL::to('pages/update/stat');?>",
		...
		success: function(data) {
			...
			{
				likes_pages_<?php echo $id;?> = data.cookies;
				updateStat(data);
...
<?php 	if (isset($_COOKIE['likes_pages_'.$id])) :
			if ($_COOKIE['likes_pages_'.$id] == 'likes') : ?>
...
<?php		elseif ($_COOKIE['likes_pages_'.$id] == 'unlikes') : ?>
...
$(document).ready(function ($) {
	...
	/*$("#btn_likes").click(function() {
		...
		if (likes_pages_<?php echo $id;?> == 'likes') {
			var param_likes = "type=likes&id=<?php echo $id;?>&action=3";
		} else if (likes_pages_<?php echo $id;?> == 'unlikes') {
			var param_likes = "type=likes&id=<?php echo $id;?>&action=3";
		} else {
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(data.status_code=='0')
				{
					likes_pages_<?php echo $id;?> = 'likes';
					$("#btn_likes").addClass("disabled");
					$("#btn_unlikes").removeClass("disabled");
					updateStat(data);
					console.log(data.data);
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(data.status_code=='0')
				{
					...
					if (likes_pages_<?php echo $id;?> == 'unlikes') {
						likes_pages_<?php echo $id;?> = '';
						$(".disp_unlikes").css( "color", "" );
						$("#btn_unlikes i").css( "color", "" );
						$("#btn_unlikes i").attr( "class", "fa fa-thumbs-o-up");
						$("#btn_unlikes").removeClass("active");
					} else if (likes_pages_<?php echo $id;?> == 'likes') {
						likes_pages_<?php echo $id;?> = 'unlikes';
