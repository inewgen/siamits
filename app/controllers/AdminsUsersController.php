...
class AdminsUsersController extends BaseController
{
    ...
    public function login()
    {
        ...
        $script = $theme->scopeWithLayout('users.jscript_login', $view)->content();
        $theme->asset()->container('inline_script')->usePath()->writeContent('custom-inline-script', $script);

        return $theme->scopeWithLayout('users.login', $view)->render();
    }
    ...
    public function register()
    {
        ...
        $script = $theme->scopeWithLayout('users.jscript_register', $view)->content();
        $theme->asset()->container('inline_script')->usePath()->writeContent('custom-inline-script', $script);

        return $theme->scopeWithLayout('users.register', $view)->render();
    }
    ...
    public function profile()
    {
        ...
        $script = $theme->scopeWithLayout('users.jscript_profile', $view)->content();
        $theme->asset()->container('inline_script')->usePath()->writeContent('custom-inline-script', $script);

        return $theme->scopeWithLayout('users.profile', $view)->render();
    }
    ...
    public function password()
    {
        ...
        $script = $theme->scopeWithLayout('users.jscript_password', $view)->content();
        $theme->asset()->container('inline_script')->usePath()->writeContent('custom-inline-script', $script);

        return $theme->scopeWithLayout('users.password', $view)->render();
    }
    ...
    public function verify()
    {
        ...
        $script = $theme->scopeWithLayout('users.jscript_verify', $view)->content();
        $theme->asset()->container('inline_script')->usePath()->writeContent('custom-inline-script', $script);

        return $theme->scopeWithLayout('users.verify', $view)->render();
    }
    ...
    public function forgot()
    {
        ...
        $script = $theme->scopeWithLayout('users.jscript_forgot', $view)->content();
        $theme->asset()->container('inline_script')->usePath()->writeContent('custom-inline-script', $script);

        return $theme->scopeWithLayout('users.forgot', $view)->render();
    }
    ...
    public function setPassword()
    {
        ...
        $script = $theme->scopeWithLayout('users.jscript_resetpassword', $view)->content();
        $theme->asset()->container('inline_script')->usePath()->writeContent('custom-inline-script', $script);

        return $theme->scopeWithLayout('users.resetpassword', $view)->render();
    }
