...
$settings['adminemail'] = "admin@siamits.com";
...
$settings['bbname'] = "SiamiTs Webbaord";
$settings['bburl'] = "http://webboard.siamits.".$env;
...
$settings['contactemail'] = "admin@siamits.com";
$settings['faxno'] = "";
$settings['contactlink'] = "contact.php";
$settings['cplanguage'] = "thai";
$settings['cpstyle'] = "default";
$settings['cookiedomain'] = ".webboard.siamits.".$env;
$settings['cookiepath'] = "/";
...
$settings['homename'] = "SiamiTs Webbaord";
$settings['homeurl'] = "http://webboard.siamits.".$env."/";
...
$settings['captchaprivatekey'] = "6LdHFwkTAAAAAJgC9xpZ8dencbCAA-7AQEMidu0y";
$settings['captchapublickey'] = "6LdHFwkTAAAAAOGwiLqArvUc1WE8PJHfGIi7O1EF";
...
$settings['returnemail'] = "admin@siamits.com";
...
$settings['smtp_host'] = "mx1.hostinger.in.th";
$settings['smtp_pass'] = "Scs@072272571";
$settings['smtp_port'] = "465";
$settings['smtp_user'] = "admin@siamits.com";
